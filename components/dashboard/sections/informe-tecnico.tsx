...
function AdjudicacionTab({ licitacion }: { licitacion: Licitacion }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      {missingRates && (
        <div style={{ background: "oklch(0.25 0.06 55 / 0.35)", border: "1px solid oklch(0.55 0.12 55 / 0.45)", borderRadius: 10, padding: "9px 14px", fontSize: 12.5, color: "oklch(0.82 0.08 60)" }}>
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
        {kpiCards.map((k) => (
          <div key={k.label} style={{
            flex: k.wide ? "1 1 140px" : "1 1 200px",
            ...
            <div style={{ fontSize: 10, letterSpacing: "0.06em", textTransform: "uppercase", fontWeight: 700, color: k.danger ? "var(--accent-red)" : k.highlight ? "var(--accent-green)" : "oklch(0.80 0 0)" }}>
              {k.label}
            </div>
            <div style={{ fontSize: 18, fontWeight: 700, color: k.color, marginTop: 4, letterSpacing: "-0.01em" }}>
              <span style={{ fontFamily: "var(--font-mono)" }}>{k.value}</span>{k.cur ? <span style={{ fontSize: 11, fontWeight: 600, color: k.danger ? "color-mix(in oklab, var(--accent-red) 80%, white)" : k.highlight ? "color-mix(in oklab, var(--accent-green) 80%, white)" : "oklch(0.72 0 0)", marginLeft: 4 }}>{curLabel}</span> : null}
            </div>
          </div>
        ))}
      </div>
              ...
              {sic !== null && (
                ...
                >
                  <div style={{ textAlign: "left" }}>
                    <div style={{ fontSize: 9.5, letterSpacing: "0.06em", textTransform: "uppercase", color: "color-mix(in oklab, var(--accent-green) 50%, oklch(0.92 0 0))", fontWeight: 700 }}>Precio SIC unitario</div>
                    <div style={{ fontSize: 13, color: "oklch(0.97 0 0)", fontWeight: 600, marginTop: 1 }}>
                      <span style={{ fontFamily: "var(--font-mono)" }}>{fmtNum(sic.arsUnit, sic.usdUnit) ?? "—"}</span> <span style={{ fontSize: 10.5, color: "color-mix(in oklab, var(--accent-green) 55%, oklch(0.90 0 0))" }}>{curLabel}</span>
                    </div>
                  </div>
                  <div style={{ width: 1, height: 24, background: "color-mix(in oklab, var(--accent-green) 22%, transparent)" }} />
                  <div style={{ textAlign: "left" }}>
                    <div style={{ fontSize: 9.5, letterSpacing: "0.06em", textTransform: "uppercase", color: "color-mix(in oklab, var(--accent-green) 50%, oklch(0.92 0 0))", fontWeight: 700 }}>Precio SIC total</div>
                    <div style={{ fontSize: 13, color: "oklch(0.97 0 0)", fontWeight: 600, marginTop: 1 }}>
                      <span style={{ fontFamily: "var(--font-mono)" }}>{fmtNum(sic.arsQty, sic.usdQty) ?? "—"}</span> <span style={{ fontSize: 10.5, color: "color-mix(in oklab, var(--accent-green) 55%, oklch(0.90 0 0))" }}>{curLabel}</span>
                    </div>
                  </div>
                </button>
              )}
              {adjOfId && (
                <span style={{ marginLeft: "auto", fontSize: 11, fontWeight: 700, padding: "4px 9px", borderRadius: 6, background: "color-mix(in oklab, var(--accent-green) 16%, transparent)", border: "1px solid color-mix(in oklab, var(--accent-green) 45%, transparent)", color: "var(--accent-green)" }}>
              ...
              {orderedOferentes.map((of, idx) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      flex: manyCards ? "1 1 230px" : "0 1 300px",
                      minWidth: manyCards ? 210 : 260, maxWidth: manyCards ? "none" : 340,
                      position: "relative",
                  ...
                  >
                    ...
                    {isBest && !isAdj && (
                      <div style={{ position: "absolute", inset: 0, borderRadius: 12, border: "1.5px solid color-mix(in oklab, var(--accent-green) 50%, transparent)", background: "linear-gradient(180deg, color-mix(in oklab, var(--accent-green) 9%, transparent), transparent 42%)", boxShadow: "0 10px 40px color-mix(in oklab, var(--accent-green) 10%, transparent)", pointerEvents: "none" }} />
                    )}
                    {isAdj && (
                      <div style={{ position: "absolute", inset: 0, borderRadius: 12, border: "2px solid color-mix(in oklab, var(--accent-green) 85%, transparent)", boxShadow: "0 0 0 4px color-mix(in oklab, var(--accent-green) 12%, transparent)", pointerEvents: "none" }} />
                    )}
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                          <div style={{
                            width: 23, height: 23, borderRadius: 6, flex: "none",
                          ...
                          {isBest && (
                            <span style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.03em", color: "var(--accent-green)", background: "color-mix(in oklab, var(--accent-green) 12%, transparent)", border: "1px solid color-mix(in oklab, var(--accent-green) 30%, transparent)", padding: "2px 7px", borderRadius: 5 }}>
                              ★ Mejor oferta
                            </span>
                          )}
                        </div>
                        {isAdj && (
                          <span style={{ fontSize: 10, fontWeight: 800, color: "oklch(0.16 0.05 155)", background: "var(--accent-green)", padding: "2px 7px", borderRadius: 5 }}>✓ Adjudicado</span>
                        )}
                      </div>

                      {/* avatar + name */}
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                        <div style={{ width: 30, height: 30, borderRadius: 8, flex: "none", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 800, background: av.bg, color: av.fg }}>
                          {initialsOf(of.nombre)}
                        </div>
                        <div style={{ minWidth: 0 }}>
                          <div style={{ fontSize: 13.5, fontWeight: 700, color: "oklch(0.98 0 0)", lineHeight: 1.25 }}>{of.nombre}</div>
                        </div>
                      </div>

                      {/* big total */}
                      <div style={{ marginBottom: 10 }}>
                        <div style={{ fontSize: 10, letterSpacing: "0.06em", textTransform: "uppercase", color: "oklch(0.82 0 0)", fontWeight: 700, marginBottom: 4 }}>
                          Precio total del renglón · {r.items.length} {r.items.length === 1 ? "ítem" : "ítems"}
                        </div>
                        <div style={{ display: "flex", alignItems: "flex-end", gap: 6 }}>
                          <div style={{ fontFamily: "var(--font-mono)", fontSize: 23, fontWeight: 700, color: "oklch(0.98 0 0)", letterSpacing: "-0.02em", lineHeight: 1 }}>
                            {fmtNum(tot.arsQty, tot.usdQty) ?? "—"}
                          </div>
                          {(tot.arsQty != null || tot.usdQty != null) && (
                            <div style={{ fontSize: 12, color: "oklch(0.82 0 0)", fontWeight: 600, paddingBottom: 2 }}>{curLabel}</div>
                          )}
                        </div>
                      </div>
                      ...
                      <div style={{ marginBottom: 12 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "7px 0", borderTop: "1px solid oklch(1 0 0 / 0.06)" }}>
                          <span style={{ fontSize: 12, color: "oklch(0.86 0 0)" }}>Precio unitario del renglón</span>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "7px 0", borderTop: "1px solid oklch(1 0 0 / 0.06)" }}>
                          <span style={{ fontSize: 12, color: "oklch(0.86 0 0)" }}>% vs. SIC</span>
                          {pct === null ? (
                            <span style={{ fontSize: 12, color: "oklch(0.78 0 0)" }}>—</span>
                          ) : cheaper ? (
                            <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11.5, fontWeight: 700, color: "var(--accent-green)", background: "color-mix(in oklab, var(--accent-green) 13%, transparent)", padding: "2px 8px", borderRadius: 5 }}>▼ {pct.toFixed(2)}%</span>
                          ) : equal ? (
                            <span style={{ display: "inline-flex", alignItems: "center", fontSize: 11.5, fontWeight: 700, color: "oklch(0.90 0 0)", background: "oklch(1 0 0 / 0.07)", padding: "2px 8px", borderRadius: 5 }}>+{pct.toFixed(2)}%</span>
                          ) : (
                            <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11.5, fontWeight: 700, color: "var(--accent-red)", background: "color-mix(in oklab, var(--accent-red) 13%, transparent)", padding: "2px 8px", borderRadius: 5 }}>{over ? "⚠ " : ""}▲ +{pct.toFixed(2)}%</span>
                          )}
                        </div>

                        <div style={{ padding: "7px 0", borderTop: "1px solid oklch(1 0 0 / 0.06)" }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, marginBottom: 8 }}>
                            <span style={{ fontSize: 12, color: "oklch(0.86 0 0)", whiteSpace: "nowrap" }}>Ahorro vs. SIC</span>
                            {ahorroOfArs == null ? (
                              <span style={{ fontSize: 12, color: "oklch(0.78 0 0)" }}>—</span>
                            ) : equal ? (
                              <span style={{ fontSize: 12, color: "oklch(0.86 0 0)" }}>Sin ahorro</span>
                            ) : (
                              <span style={{ fontSize: 13, fontWeight: 700, color: cheaper ? "var(--accent-green)" : "var(--accent-red)", whiteSpace: "nowrap", display: "inline-flex", alignItems: "baseline", gap: 3 }}>
                                <span style={{ fontFamily: "var(--font-mono)" }}>{cheaper ? "+" : "−"}{fmtNum(Math.abs(ahorroOfArs), Math.abs(ahorroOfArs) / (fdOp ?? 1)) ?? ""}</span>
                                <span style={{ fontSize: 10.5, fontWeight: 500, opacity: 0.85 }}>{curLabel}</span>
                              </span>
                            )}
                          </div>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "7px 0", borderTop: "1px solid oklch(1 0 0 / 0.06)" }}>
                          <span style={{ fontSize: 12, color: "oklch(0.86 0 0)" }}>Informe técnico</span>
                          {cumple === true ? (
                            <span style={{ fontSize: 11, fontWeight: 700, color: "var(--accent-green)", background: "color-mix(in oklab, var(--accent-green) 12%, transparent)", padding: "3px 8px", borderRadius: 6 }}>✓ Cumple</span>
                          ) : cumple === false ? (
                            <span style={{ fontSize: 11, fontWeight: 700, color: "var(--accent-red)", background: "color-mix(in oklab, var(--accent-red) 12%, transparent)", padding: "3px 8px", borderRadius: 6 }}>✗ No cumple</span>
                          ) : evaluated ? (
                            <span style={{ fontSize: 11, fontWeight: 700, color: "var(--accent-amber)", background: "color-mix(in oklab, var(--accent-amber) 12%, transparent)", padding: "3px 8px", borderRadius: 6 }}>⏳ Pendiente</span>
                          ) : (
                            <span style={{ fontSize: 12, color: "oklch(0.80 0 0)" }}>Sin evaluar</span>
                          )}
                        </div>

                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "7px 0", borderTop: "1px solid oklch(1 0 0 / 0.06)" }}>
                          <span style={{ fontSize: 12, color: "oklch(0.86 0 0)" }}>Cobertura del renglón</span>
                          {r.items.length === 0 ? (
                            <span style={{ fontSize: 12, color: "oklch(0.80 0 0)" }}>—</span>
                          ) : tot.cobertura === r.items.length ? (
                            <span style={{ fontSize: 11, fontWeight: 700, color: "var(--accent-green)", background: "color-mix(in oklab, var(--accent-green) 12%, transparent)", padding: "3px 8px", borderRadius: 6 }}>✓ Completo · {tot.cobertura}/{r.items.length}</span>
                          ) : tot.cobertura > 0 ? (
                            <span style={{ fontSize: 11, fontWeight: 700, color: "var(--accent-red)", background: "color-mix(in oklab, var(--accent-red) 12%, transparent)", padding: "3px 8px", borderRadius: 6 }}>Incompleto · {tot.cobertura}/{r.items.length}</span>
                          ) : (
                            <span style={{ fontSize: 12, color: "oklch(0.80 0 0)" }}>Sin ofertar</span>
                          )}
                        </div>
                      </div>
                      ...
                      {/* action */}
                      {isAdj ? (
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, background: "color-mix(in oklab, var(--accent-green) 16%, transparent)", border: "1px solid color-mix(in oklab, var(--accent-green) 55%, transparent)", color: "var(--accent-green)", fontWeight: 800, fontSize: 12.5, borderRadius: 8, height: 36 }}>
                          ✓ Adjudicado
                          <button
                            onClick={() => handleAdjudicar(r.id, of.id)}
                            disabled={isSaving}
                            style={{ background: "none", border: "none", cursor: isSaving ? "wait" : "pointer", color: "oklch(0.88 0 0)", fontWeight: 600, fontSize: 12.5, textDecoration: "underline" }}
                          >
                        ...
                        <button
                          onClick={() => handleAdjudicar(r.id, of.id)}
                          disabled={isSaving}
                          style={{ width: "100%", height: 36, border: "none", borderRadius: 8, background: "var(--accent-green)", color: "oklch(0.16 0.05 155)", fontWeight: 800, fontSize: 12.5, cursor: isSaving ? "wait" : "pointer" }}
                        ...
                        >
                          {isSaving ? <Loader2 className="w-3.5 h-3.5 animate-spin inline" /> : "Adjudicar a este oferente"}
                        </button>
                      ) : (
                        <button
                          onClick={() => handleAdjudicar(r.id, of.id)}
                          disabled={isSaving}
                          style={{ width: "100%", height: 36, border: "1px solid oklch(1 0 0 / 0.14)", borderRadius: 8, background: "transparent", color: "oklch(0.82 0 0)", fontWeight: 700, fontSize: 12.5, cursor: isSaving ? "wait" : "pointer" }}
                        ...
                        >
                          {isSaving ? <Loader2 className="w-3.5 h-3.5 animate-spin inline" /> : "Adjudicar"}
                        </button>
                      )}
                    </div>
                  </div>
      ...
      {/* Summary */}
      {adjMap.size > 0 && (
        <div style={{ background: "var(--panel-2)", border: "1px solid var(--hairline)", borderRadius: 10, padding: "12px 14px" }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "oklch(0.80 0 0)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 8 }}>
            ...
            {renglones.map((r) => {
              ...
              return (
                <div key={r.id} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13 }}>
                  <span style={{ fontFamily: "var(--font-mono)", color: "var(--accent-green)", fontWeight: 600, width: 84, flexShrink: 0 }}>Renglón {r.numero}</span>
                  {adjOf ? (
                    <>
                      <span style={{ color: "oklch(0.96 0 0)", fontWeight: 500 }}>{adjOf.nombre}</span>
                      {complete && tot && (
                        <span style={{ marginLeft: "auto", fontFamily: "var(--font-mono)", fontSize: 13, color: "oklch(0.85 0 0)" }}>
          ...
          <div style={{ background: "var(--panel-2)", border: "1px solid var(--hairline)", borderRadius: 12, padding: "14px 16px" }}>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
                ...
                <div style={{ fontSize: 12, color: "oklch(0.86 0 0)", marginTop: 3, lineHeight: 1.5 }}>
